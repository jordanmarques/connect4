...
import com.connect4.model.Games;
...
public class GridCheckerServiceTest {

   @Autowired
   GridCheckerService gridCheckerService;
   ...
   public void should_detect_a_winner_horizontally(){
      ...
      assertThat(gridCheckerService.checkHorizontally(game, Color.Red)).isTrue();
   }
   @Test
   ...
   public void should_not_detect_a_winner_horizontally(){
      ...
      assertThat(gridCheckerService.checkHorizontally(game, Color.Red)).isFalse();
   }
   ...
   public void should_detect_a_winner_vertically(){
      ...
      assertThat(gridCheckerService.checkVertically(game, Color.Red)).isTrue();
   }
   @Test
   public void should_not_detect_a_winner_vertically(){
      ...
      assertThat(gridCheckerService.checkVertically(game, Color.Red)).isFalse();
   }
   ...
   public void should_detect_a_winner_right_transversal(){
      ...
      assertThat(gridCheckerService.checkRightTransversal(game, Color.Red)).isTrue();
   }
   @Test
   ...
   public void should_not_detect_a_winner_right_transversal(){
      ...
      assertThat(gridCheckerService.checkRightTransversal(game, Color.Red)).isFalse();
   }
   ...
   public void should_detect_a_winner_left_transversal(){
      ...
      assertThat(gridCheckerService.checkLeftTransversal(game, Color.Red)).isTrue();
   }
   @Test
   ...
   public void should_not_detect_a_winner_left_transversal_2(){
      ...
      assertThat(gridCheckerService.checkLeftTransversal(game, Color.Red)).isFalse();
   }
}